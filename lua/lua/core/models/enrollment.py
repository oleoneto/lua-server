...
class Enrollment(models.Model):
    ...
    course_offer = models.ForeignKey(CourseOffer, related_name='enrollments',
                                     on_delete=models.DO_NOTHING)
    ...
    def save(self, *args, **kwargs):
        ...
        if self.course_offer.enrollments.count() >= self.course_offer.enrollment_limit:
            Waitlist.objects.get_or_create(student=self.student,
    ...
    def delete(self, using=None, keep_parents=False):
        ...
        if waiting_instance:
            try:
                ...
                Enrollment.objects.create(student=waiting_instance.student,
                                          course_offer=waiting_instance.course_offer)
